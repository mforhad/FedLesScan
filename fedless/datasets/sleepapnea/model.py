...
def load_data():
    ...
    x_train = []
    o_train, y_train = apnea_ecg["o_train"][:16000], apnea_ecg["y_train"][:16000]
    groups_train = apnea_ecg["groups_train"][:16000]
    ...
    x_test = []
    o_test, y_test = apnea_ecg["o_test"][:16000], apnea_ecg["y_test"][:16000]
    groups_test = apnea_ecg["groups_test"][:16000]
...
def create_sleep_apnea_model(input_shape):
    weight=1e-3
...
def get_sleep_apnea_input_shape():
...
#     # model.compile(optimizer="adam", loss="categorical_crossentropy", metrics=['accuracy'])
#
#     model = create_sleep_apnea_model(input_shape=input_shape)
#
